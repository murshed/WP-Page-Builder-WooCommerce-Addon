...
class wppbwca_shortcode{

	public function get_name(){
		return 'WP_Page_Builder_WC_Addon';
	}
	public function get_title(){
		return 'WC Latest Products';
	}
	public function get_icon() {
		return 'wppb-font-shopping-cart2';
	}
	public function get_category_name(){
        return 'WooCommerce Addons by Fahim Murshed';
    }
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'woo_number' => array(
			    'type' => 'text',
			    'title' => __('Number of Products','wppbwcaaddon'),
			    'std' => '8',
			),
			'woo_column' => array(
				'type' => 'select',
				'responsive' => true,
				'title' => __('Post Column','wppbwcaaddon'),
				'placeholder' => __('Number of Column','wppbwcaaddon'),
				'values' => array(
                    '12' =>  __( 'One Column', 'wppbwcaaddon' ),
                    '6' =>  __( 'Two Column', 'wppbwcaaddon' ),
                    '4' =>  __( 'Three Column', 'wppbwcaaddon' ),
                    '3' =>  __( 'Four Column', 'wppbwcaaddon' )
                ),
                'std' => '3'
			),
			'woo_order_by' => array(
			    'type' 	 => 'select',
			    'title'  => __('Select title element','wppbwcaaddon'),
			    'values' => array(
			        	'DESC' 		=> __( 'Descending', 'wppbwcaaddon' ),
                        'ASC' 		=> __( 'Ascending', 'wppbwcaaddon' ),
			    ),
			    'std' => 'DESC',
			),
			'title_color'=> array(
			...
			'title_typography' => array(
				'tab' => 'style',
				'type' => 'typography',
				'title' => __('Title Typography','wppbwcaaddon'),
				'std' => array(
		            ...
		            <div class="col-md-6 col-lg-<?php echo $woo_column['md']; ?> product-item">
						<div class="inner">
							...
							<div class="hover-content">
								<a rel="nofollow" href="?add-to-cart=<?php echo $data->post->ID ?>" data-quantity="1" data-product_id="<?php echo $data->post->ID ?>" data-product_sku="" class="love product_type_simple add_to_cart_button ajax_add_to_cart"><i class="wppb-font-shopping-cart2"></i></a>
	                            <a href="<?php the_permalink(); ?>" class="love"><i class="fa fa-link"></i></a>
	                        </div>
						</div>
					</div>
		        <?php endwhile; ?>
